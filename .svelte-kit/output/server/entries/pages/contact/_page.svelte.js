...
import { V as Vector } from "../../../chunks/vector.js";
...
const css$3 = {
  code: "section.svelte-vowb1i{display:flex;flex-direction:column;width:100%;padding-right:var(--padding)}form.svelte-vowb1i{display:flex;flex-direction:column;width:100%;gap:4px;margin-top:2rem}.radio-2.svelte-vowb1i{margin-bottom:0.5rem}input[type='text'].svelte-vowb1i,input[type='email'].svelte-vowb1i,input[type='tel'].svelte-vowb1i,textarea.svelte-vowb1i{border:none;padding:0.5rem;margin-bottom:0.5rem;border-radius:var(--bradius);font-family:'Mulish', sans-serif}input[type='submit'].svelte-vowb1i{margin-top:1rem;margin-bottom:2rem;border:none;border-radius:var(--bradius);padding:0.5rem;width:6rem;background-color:var(--button-color);color:var(--text-color);font-weight:bold;cursor:pointer}input[type='submit'].svelte-vowb1i:hover{color:var(--button-color);background-color:var(--text-color)}@media(min-width: 760px){section.svelte-vowb1i{width:50%}}",
  map: null
};
const ContactForm = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$3);
  return `<section class="svelte-vowb1i">${validate_component(NewContactInfo, "ContactInfo").$$render($$result, {}, {}, {})} <form action="https://api.web3forms.com/submit" method="POST" class="svelte-vowb1i" data-svelte-h="svelte-1h0ky7j"><input type="hidden" name="access_key" value="59b62920-afbb-4637-be5f-736618bec604">   <input type="hidden" name="redirect" value="https://web3forms.com/success">  <input type="checkbox" name="botcheck" class="hidden" style="display: none;"> <label for="reason">Reden voor contact:</label> <div><input type="radio" id="question" name="contact-reason" value="question" checked> <label for="question">Ik heb een vraag</label></div> <div class="radio-2 svelte-vowb1i"><input type="radio" id="workshop" name="contact-reason" value="workshop"> <label for="workshop">Ik wil mij aanmelden voor een workshop</label></div> <label for="name">Voornaam:</label> <input type="text" id="name" name="name" placeholder="Voer je voornaam in" required class="svelte-vowb1i"> <label for="lastname">Achternaam:</label> <input type="text" id="lastname" name="lastname" placeholder="Voer je achternaam in" required class="svelte-vowb1i"> <label for="email">E-mail:</label> <input type="email" id="email" name="email" placeholder="Voer je e-mailadres in" required class="svelte-vowb1i"> <label for="phone-number">Telefoonnummer:</label> <input type="tel" id="phone-number" name="phone-number" inputmode="numeric" pattern="[0-9]*" placeholder="Voer je telefoonnummer in" required class="svelte-vowb1i"> <label for="message">Stel je vraag of vertel voor welke workshop je je wilt
      aanmelden!</label> <textarea id="message" name="message" cols="30" rows="10" placeholder="Typ hier je bericht" required class="svelte-vowb1i"></textarea> <input type="submit" value="Verzenden" class="svelte-vowb1i"></form> </section>`;
});
const css$2 = {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$result.css.add(css);
  return `${validate_component(Navigation, "Navigation").$$render($$result, {}, {}, {})} ${validate_component(ContactImage, "ContactImage").$$render($$result, { data }, {}, {})} <main class="svelte-12fe41"><div class="wrapper svelte-12fe41">${validate_component(ContactForm, "ContactForm").$$render($$result, {}, {}, {})} ${validate_component(Location, "Location").$$render($$result, {}, {}, {})}</div></main> ${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})}`;
});
export {
  Page as default
};
