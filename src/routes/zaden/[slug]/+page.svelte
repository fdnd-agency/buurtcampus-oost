    ...
    <div class="stekje-container">
      ...
      <div class="right">
        <details>
          ...
          >
          <div class="content">
            <p>{data.zaden.landvanherkomst}</p>
          </div>
        </details>
